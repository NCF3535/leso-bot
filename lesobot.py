...
parameters = {
    ...
    "chat_id" : "-961147267",
    "text" : "Heroku Server has restarted at %s, %s"%(dt.date(),dt.strftime("%H:%M:%S"))
...
def rollcallplus(resp):
    ...
    parameters = {
      ...
      "options" : json.dumps(["In Office (Whole day, AM+PM)","In Office (AM only)","In Office (PM Only)", "WFH", "L/L", "O/L", "CCL", "CSL", "PCL", "Others"]),
